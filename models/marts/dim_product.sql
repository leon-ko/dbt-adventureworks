...
final as (
    select
        ...
        coalesce(product_subcategory.product_subcategory_name, 'unknown') as product_subcategory_name,
        coalesce(product_category.product_category_id, 0) as product_category_id,
        coalesce(product_category.product_category_name, 'unknown') as product_category_name
